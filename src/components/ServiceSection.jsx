...
const conditions = [
  { value: '$800–1 800', label: 'Зарплата + чаевые, зависит от позиции и страны', color: 'text-blue-600' },
    ...
    <section className="py-20 lg:py-28 bg-gray-50" id="service">
      <div className="max-w-6xl mx-auto px-4" ref={ref}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Сфера сервиса</span>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {positions.map((pos, i) => (
            <div key={i} className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all">
        ...
        {/* Requirements */}
        <div className="bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-2xl p-8 mb-12">
          <h3 className="text-xl font-bold mb-6">Требования</h3>
          <div className="grid sm:grid-cols-2 gap-4">
            {requirements.map((req, i) => (
              <div key={i} className="flex items-start gap-3">
                <CheckIcon className="w-5 h-5 text-blue-500 mt-0.5 shrink-0" />
        ...
        <div className="text-center">
          <a href="#quiz" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-full text-lg transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/25">
            Узнать, подхожу ли я
