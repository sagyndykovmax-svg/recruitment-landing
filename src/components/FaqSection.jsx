...
const faqs = [
  ...
  {
    q: 'Безопасно ли это для женщин?',
    a: 'Да. Вы работаете в легальных компаниях с охраной и правилами. Живёте в безопасном районе. На месте есть русскоязычные координаторы, которые помогают в любой ситуации. Мы остаёмся на связи на весь период контракта.',
  },
  {
